// written by Louis Hoebregts (c) 2017
// Github: https://github.com/Mamboleoo/InfiniteTubes
...
function Particle(scene, burst, time) {
  ...
  if(burst){
    ...
    var offset = 275;
    this.color = new THREE.Color("hsl("+(Math.random()*range+offset)+",100%,72%)");
  }

  // geometry colors and sizes
